...
Xception=tf.keras.applications.xception.Xception(input_shape=(299,299, 3), include_top=False, weights="imagenet")
...
mc = ModelCheckpoint("Xception.h5", monitor='val_acc', mode='max', save_best_only=True)
