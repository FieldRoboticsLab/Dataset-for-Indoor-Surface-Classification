...
IncResNetV2= tf.keras.applications.InceptionResNetV2(input_shape=(299,299, 3), include_top=False, weights="imagenet")
...
for layer in IncResNetV2.layers:
...
model=tf.keras.models.Model(IncResNetV2.input,x)
...
mc = ModelCheckpoint("InceptioResNet50V2.h5", monitor='val_acc', mode='max', save_best_only=True)
